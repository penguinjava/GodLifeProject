  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
      ...
      <div class="text-center mb-8">
        <div
            class="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl mx-auto mb-4 flex items-center justify-center">
          <img alt="아이콘" src="/images/ms-icon-310x310.png"/>
        </div>
      ...
      <div v-else class="space-y-4">
        ...
        >
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            <path
                d="M12 3c5.5 0 10 3.58 10 8 0 4.42-4.5 8-10 8-1.12 0-2.2-.16-3.22-.46L3 21l1.94-5.78C3.86 14.36 2 11.64 2 8.5 2 6.01 6.5 3 12 3z"/>
          </svg>
          카카오톡으로 시작하기
        </button>
        ...
        <p class="text-xs text-gray-500 text-center">
          로그인 시 <a class="text-blue-600 hover:underline" href="#">이용약관</a>과
          <a class="text-blue-600 hover:underline" href="#">개인정보처리방침</a>에 동의합니다.
        </p>
      </div>
    </div>
  </div>
